 ...
 * EmbeddingGemma) — nothing leaves the machine. "openai" sends the keyword
 * and candidate status text to FediPod's /api/v1/ailo/ai/filters/match,
 * which calls OpenAI's embeddings API — opt-in per keyword, never the default.
 */
